...
public class Main {
	...
	private final static String TARGET_FILE = "./src/main/java/data/melon_to_spotify31.json";
	...
	private static void make_mapping_table(SpotifyApi spotifyApi) throws Exception {
		...
		List<String>[] melonDataSets = readJsonFile(670824, 672000); // [] 폐구간 651001~672000
