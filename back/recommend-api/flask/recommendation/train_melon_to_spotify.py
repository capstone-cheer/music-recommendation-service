...
# change 숫자
# File_no = 21 건너뜀
FILE_NO = 0  # 항상 완료된 FILE_NO가 적혀있도록 유지하자. 작업을 시작할 때 FILE_NO의 값을 바꾸면서 시작하도록 하자.
MAPPING_FILE_NAME = "melon_to_spotify{0}.json".format(FILE_NO)
...
FILE_PATH = "/Users/kangho/Documents/github-repo/capstone-cheer/back/recommend-api/recommendation/datasets"
